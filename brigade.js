...
events.on("push", (brigadeEvent, project) => {
    ...
    brigConfig.set("webImage", "sivak8s/python-flask-sklearn-docker-template")
...
function kubeJobRunner (config, k) {
    ...
    k.tasks = [
        `kubectl set image deployment/heroes-web-deploy heroes-web-cntnr=sivak8s.azurecr.io/sivak8s/python-flask-sklearn-docker-template:${config.get("imageTag")}`
    ]
}
